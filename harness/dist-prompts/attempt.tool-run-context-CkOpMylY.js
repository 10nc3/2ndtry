...
import { C as resolvePluginControlPlaneFingerprint } from "./plugin-registry-BZohWtpt.js";
import { g as freezeDiagnosticTraceContext } from "./diagnostic-events-DQZruzVY.js";
import { t as createSubsystemLogger } from "./subsystem-C-H8Q21Y.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-Cv-AJRtd.js";
import "./plugins-CRFmOWRX.js";
import { $ as resolveProviderRuntimePlugin, _ as normalizeProviderToolSchemasWithPlugin, f as inspectProviderToolSchemasWithPlugin } from "./provider-runtime-o0ZjFTlv.js";
import "./model-selection-D3moOxKB.js";
import { i as normalizeToolName } from "./tool-policy-shared-COgLnula.js";
import "./tool-policy-DDjhZ9Xq.js";
import { d as isGoogleModelApi } from "./pi-embedded-helpers-BroJgBLX.js";
import { o as normalizeTargetForProvider } from "./target-id-resolution-DGzyuxXo.js";
import { r as splitMediaFromOutput } from "./parse-YHEUXIa4.js";
import { t as pluginRegistrationContractRegistry } from "./registry-8lBMtPo4.js";
import { t as log$1 } from "./logger-CPibDDiT.js";
import { u as shouldPreserveThinkingBlocks } from "./provider-replay-helpers-CspW0bHG.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-ZpEMdx78.js");
