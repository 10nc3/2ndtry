        ...
        <aside class="sidebar ${navCollapsed ? "sidebar--collapsed" : ""}">
          <div class="sidebar-shell">
            <div class="sidebar-shell__header">
              <div class="sidebar-brand sidebar-brand--cat">
                <canvas class="sidebar-brand__canvas" id="sidebarCat"></canvas>
              </div>
              <button
                type="button"
            ...
            <div class="sidebar-shell__footer">
              <div class="sidebar-utility-group">
                <div class="sidebar-clock">
                  <span class="sidebar-clock__digital" id="sidebarClockDigital"></span>
                  <canvas class="sidebar-clock__analog" id="sidebarClockAnalog" width="32" height="32"></canvas>
                </div>
